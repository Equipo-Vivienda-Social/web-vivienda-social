      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: "0.95rem", opacity: 0.9 }}>
            ...
            <svg width="23px" height="23px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#1D3557"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect width="15" height="15" fill="#1D3557"></rect> <path d="M18 9C18 13.7462 14.2456 18.4924 12.6765 20.2688C12.3109 20.6827 11.6891 20.6827 11.3235 20.2688C9.75444 18.4924 6 13.7462 6 9C6 7 7.5 3 12 3C16.5 3 18 7 18 9Z" stroke="#FFFFFF" stroke-linejoin="round"></path> <circle cx="12" cy="9" r="2" stroke="#FFFFFF" stroke-linejoin="round"></circle> </g></svg>
